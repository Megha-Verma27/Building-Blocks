...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConfirmPassword = (EditText) findViewById(R.id.register_password_input_again);
    ...
    private void CreateAccount()
    {
        ...
        else
        {
            ...
            {
                Toast.makeText(this, "IncorrectPassword....", Toast.LENGTH_SHORT).show();
                    ...
                    RootRef.child("Users").child(phone).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    {
                                        Toast.makeText(RegisterActivity.this, "Congratulations! your account create successfully.", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
